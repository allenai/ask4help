...
class ObjectNavRoboThorClipRGBResidualDaggerExperimentConfig(
    ObjectNavRoboThorBaseConfig,
    ObjectNavMixInPPOConfig,
    ObjectNavMixInClipResNetGRUConfig,
):
    ...
    @classmethod
    def tag(cls):
        return "Objectnav-RoboTHOR-RGB-ClipResNet50GRU-Residual-Dagger"
    ...
    def training_pipeline(self, **kwargs):
        ...
        assert self.ADAPT_BELIEF, "Model should be adaptive - and pre-trained"
        # TODO The model automatically does teacher forcing! We need to internally manage the annealing
        stages = [
            PipelineStage(
