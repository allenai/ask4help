...
class ObjectNavRoboThorBaseConfig(ObjectNavThorBaseConfig, ABC):
    ...
    THOR_COMMIT_ID = "598ca7d8031053eb025400bddbc8a3d0d31e5097"
    ...
    VAL_DATASET_DIR = os.path.join(os.getcwd(), "datasets/robothor-objectnav/scene_wise_eps_split/FloorPlan_Val1_1")
